...
`);const e=document.querySelector(".timeline");e===null?(this.isTimelineNull=!0,this.element=document.createElement("main"),this.element.classList.add("timeline"),this.element.innerHTML=this.beaudarArticle):(this.isTimelineNull=!1,this.element=e,document.querySelector("#beaudarMsg")===null&&(W.inputPosition==="top"&&this.element.firstElementChild.insertAdjacentHTML("afterend",this.beaudarArticle),W.inputPosition==="bottom"&&this.element.lastElementChild.insertAdjacentHTML("beforebegin",this.beaudarArticle)))}createMsgElement(e,n,s,r){let i="",o="";r&&(i='<button id="reload-button" type="button" class="btn btn-primary" >\u5237\u65B0</button>'),s&&(o=`<p><a href="https://lipk.org/blog/2020/06/08/beauder-qa/${s}" target="_blank">\u83B7\u53D6\u6B64\u95EE\u9898\u7684\u5E2E\u52A9\u4FE1\u606F</a></p>`),this.element.querySelector("#beaudarMsg").insertAdjacentHTML("beforeend",`
    <h3>${e}</h3>
    ${n}
    ${o}
    ${i}`),this.isTimelineNull&&document.body.appendChild(this.element);const l=this.element.querySelector("#reload-button");l&&(l.onclick=()=>{window.location.reload()}),h()}}const x={value:null},Ae=v(location),Z=t=>`${_}/authorize?${new URLSearchParams({redirect_uri:t})}`;async function Be(){const t=`${_}/token`,e=await fetch(t,{method:"POST",mode:"cors",credentials:"include",headers:{"content-type":"application/json"},body:JSON.stringify(Ae.session)}).catch(n=>{throw new D().createMsgElement("Token \u8BF7\u6C42\u5931\u8D25","\u7F51\u7EDC\u65AD\u5F00\u6216\u7F51\u7EDC\u4E0D\u7A33\u5B9A\uFF0C\u68C0\u67E5\u7F51\u7EDC\u8FDE\u63A5\uFF0C\u70B9\u51FB<code>\u5237\u65B0</code>\u91CD\u8BD5\u3002","#qtoken-\u8BF7\u6C42\u5931\u8D25",!0),L(),new Error(`token \u8BF7\u6C42\u5931\u8D25\uFF0C${n}`)});if(e.ok){const n=await e.json();x.value=n}}const a=v(location);let I;const g=(t,e)=>{e=e||{},e.mode="cors",e.cache="no-cache";const n=new Request(q+t,e);return n.headers.set("Accept",w),x.value!==null&&n.headers.set("Authorization",`token ${x.value}`),n},Q={standard:{limit:Number.MAX_VALUE,remaining:Number.MAX_VALUE,reset:0},search:{limit:Number.MAX_VALUE,remaining:Number.MAX_VALUE,reset:0}},Ce=t=>{const e=t.headers.get("X-RateLimit-Limit"),n=t.headers.get("X-RateLimit-Remaining"),s=t.headers.get("X-RateLimit-Reset"),r=/\/search\//.test(t.url),i=r?Q.search:Q.standard;if(i.limit=+e,i.remaining=+n,i.reset=+s,t.status===403&&i.remaining===0){const o=new Date(0);o.setUTCSeconds(i.reset);const l=Math.round((o.getTime()-new Date().getTime())/1e3/60),c=r?"search API":"non-search APIs";new D().createMsgElement("\u83B7\u53D6\u8BC4\u8BBA\u6570\u636E\u5931\u8D25",`<p>\u8D85\u51FA\u4E86 ${c} \u7684\u901F\u7387\u9650\u5236\uFF0C\u5728 ${l} \u5206\u949F\u540E\u91CD\u7F6E</p>`,"",!0)}},p=t=>fetch(t).then(e=>(e.status===401&&(x.value=null),e.status===403&&e.json().then(n=>{n.message==="Resource not accessible by integration"&&window.dispatchEvent(new CustomEvent("not-installed"))}),Ce(e),t.method==="GET"&&[401,403].indexOf(e.status)!==-1&&t.headers.has("Authorization")?(t.headers.delete("Authorization"),p(t)):e)),we=(t,e=!1)=>{const n=g(`repos/${a.owner}/${a.repo}/contents/${t}?ref=${a.branch}`);return e&&n.headers.set("accept",ce),p(n).then(s=>{if(s.status===404)throw new D().createMsgElement(`\u7F3A\u5C11 "${t}" \u914D\u7F6E`,`<p>\u5728\u5B58\u50A8\u5E93 "${a.owner}/${a.repo}" \u4E2D\uFF0C"${a.branch}" \u5206\u652F\u4E0B\u627E\u4E0D\u5230 "${t}"\u3002</p>`,"#q\u7F3A\u5C11-beaudarjson-\u914D\u7F6E-\u6216-\u4E0D\u5141\u8BB8-xxx-\u53D1\u5E03\u5230-xxxxxx"),new Error(`\u5728\u5B58\u50A8\u5E93 "${a.owner}/${a.repo}" \u4E2D\uFF0C"${a.branch}" \u5206\u652F\u4E0B\u627E\u4E0D\u5230 "${t}"`);if(s===void 0||!s.ok)throw new Error(`${t} \u63D0\u53D6\u5931\u8D25`);return e?s.text():s.json()}).then(s=>{if(e)return s;const{content:r}=s,i=be(r);return JSON.parse(i)})},$e=t=>{const e=`"${t}" type:issue in:title repo:${a.owner}/${a.repo}`,n=g(`search/issues?q=${encodeURIComponent(e)}&sort=created&order=asc`);return p(n).then(s=>{if(s===void 0||!s.ok)throw new Error("\u641C\u7D22 Issues \u5931\u8D25\u3002");return s.json()}).then(s=>{if(s.total_count===0)return null;s.total_count>1&&console.warn(`\u5339\u914D\u5230\u591A\u4E2A\u95EE\u9898 "${e}"`),t=t.toLowerCase();for(const r of s.items)if(r.title.toLowerCase().indexOf(t)!==-1)return r;return console.warn(`Issue \u641C\u7D22\u7ED3\u679C\u4E2D\u6CA1\u6709\u4E0E "${t}" \u6807\u9898\u5339\u914D\u7684\u8BC4\u8BBA\u3002`),null})},xe=t=>{const e=g(`repos/${a.owner}/${a.repo}/issues/${t}`);return p(e).then(n=>{if(n===void 0||!n.ok)throw new Error("\u901A\u8FC7 Issue \u7F16\u53F7\u63D0\u53D6\u8BC4\u8BBA\u65F6\u51FA\u9519");return n.json()})},Fe=(t,e)=>{const n=`repos/${a.owner}/${a.repo}/issues/${t}/comments?page=${e}&per_page=${$}`,s=g(n),r=`${O},${w}`;return s.headers.set("Accept",r),s},b=(t,e)=>{const n=Fe(t,e);return p(n).then(s=>{if(s===void 0||!s.ok)throw new Error("\u63D0\u53D6\u8BC4\u8BBA\u65F6\u51FA\u9519\u3002");return s.json()})},De=()=>x.value===null?Promise.resolve(null):p(g("user")).then(t=>t.ok?t.json():null),ye=(t,e,n,s,r)=>{const i=`${_}/repos/${a.owner}/${a.repo}/issues${r?`?label=${encodeURIComponent(r)}`:""}`,o=new Request(i,{method:"POST",body:JSON.stringify({title:t,body:`# ${n}

${s}

[${e}](${e})`})});return o.headers.set("Accept",w),o.headers.set("Authorization",`token ${x.value}`),fetch(o).then(l=>{if(l===void 0||!l.ok)throw new Error("\u521B\u5EFA\u8BC4\u8BBA issue \u65F6\u51FA\u9519");return l.json()})},Le=(t,e)=>{const n=`repos/${a.owner}/${a.repo}/issues/${t}/comments`,s=JSON.stringify({body:e}),r=g(n,{method:"POST",body:s}),i=`${O},${w}`;return r.headers.set("Accept",i),p(r).then(o=>{if(o===void 0||!o.ok)throw new Error("\u53D1\u5E03\u8BC4\u8BBA\u65F6\u51FA\u9519");return o.json()})};async function ke(t,e){t=t.replace(q,"");const n=JSON.stringify({content:e}),s=g(t,{method:"POST",body:n});s.headers.set("Accept",w);const r=await p(s),i=r.ok?await r.json():null;if(r.status===201)return{reaction:i,deleted:!1};if(r.status!==200)throw new Error("\u9884\u671F\u7684\u201C 201 \u54CD\u5E94\u5DF2\u521B\u5EFA\u201D\u6216\u201C 200 \u54CD\u5E94\u5DF2\u5B58\u5728\u201D");const o=g(`${t}/${i.id}`,{method:"DELETE"});return o.headers.set("Accept",w),await p(o),{reaction:i,deleted:!0}}const Te=t=>{const e=JSON.stringify({text:t,mode:"gfm",context:`${a.owner}/${a.repo}`});return p(g("markdown",{method:"POST",body:e})).then(n=>n.text())};async function Se(){if(!I&&(I=await we("beaudar.json").then(t=>(Array.isArray(t.origins)||(t.origins=[]),t)),I.origins.indexOf(a.origin)===-1))throw L(),new D().createMsgElement(`\u9519\u8BEF: <code>${a.origin}</code> \u8BC4\u8BBA\u4E0D\u5141\u8BB8\u53D1\u5E03\u5230\u4ED3\u5E93 <code>${a.owner}/${a.repo}</code>`,`
    <p>&emsp;&emsp;\u8BF7\u786E\u8BA4 <code>${a.owner}/${a.repo}</code> \u662F\u672C\u7AD9\u70B9\u8BC4\u8BBA\u7684\u6B63\u786E\u4ED3\u5E93\u3002\u5982\u679C\u60A8\u62E5\u6709\u6B64\u4ED3\u5E93\uFF0C
    <a href="https://github.com/${a.owner}/${a.repo}/edit/master/beaudar.json" target="_blank">
      <strong>\u6DFB\u52A0\u6216\u66F4\u65B0 beaudar.json</strong>
    </a>
    \u6DFB\u52A0 <code>${a.origin}</code> \u5230\u6765\u6E90\u5217\u8868\u3002</p>
    <p>\u9700\u8981\u914D\u7F6E\uFF1A</p>
    <pre><code>${JSON.stringify({origins:[a.origin]},null,2)}</code></pre>
    `,"#q\u7F3A\u5C11-beaudarjson-\u914D\u7F6E-\u6216-\u4E0D\u5141\u8BB8-xxx-\u53D1\u5E03\u5230-xxxxxx"),new Error(`\u8BC4\u8BBA\u53D1\u5E03\u88AB\u7981\u6B62\uFF0C<code>${a.origin}</code> \u8BC4\u8BBA\u4E0D\u5141\u8BB8\u53D1\u5E03\u5230\u4ED3\u5E93 <code>${a.owner}/${a.repo}</code>\u3002`)}const _e=v(location),ee=(t,e,n,s)=>`
  <button
    reaction
    type="submit"
    action="javascript:"
    ...
    ${n?"disabled":""}>
    ${de[e]}
  </button>`,Me=t=>{const e=async n=>{const s=n.target instanceof HTMLElement&&n.target.closest("button");if(!s||!s.hasAttribute("reaction")||(n.preventDefault(),!t))return;s.disabled=!0;const r=s.closest("details");r&&(r.open=!1);const i=s.formAction,o=s.value,{deleted:l}=await ke(i,o),c=`button[reaction][formaction="${i}"][value="${o}"],[reaction-count][reaction-url="${i}"]`,d=Array.from(document.querySelectorAll(c)),f=l?-1:1;for(const E of d)E.setAttribute("reaction-count",(parseInt(E.getAttribute("reaction-count"),10)+f).toString());s.disabled=!1,h()};addEventListener("click",e,!0)},te=(t,e)=>{let n="",s="";e==="center"?n="left: 50%;top: 75%;transform: translateX(-50%)":e==="right"?(s="Popover-message--top-right",n="right:11px"):e==="left"&&(s="Popover-message--bottom-left",n="transform: translateX(-1%) translateY(-133%)");const r=i=>ee(t,i,!1,0)+`<span class="reaction-name" aria-hidden="true">${G[i]}</span>`;return`
  ...
  <details class="details-overlay details-popover reactions-popover">
  ...
  </details>`};class Ie{constructor(e,n,s){u(this,"element");this.comment=e,this.currentUser=n;const{user:r,html_url:i,created_at:o,body_html:l,author_association:c,reactions:d}=e;this.element=document.createElement("article"),this.element.classList.add("timeline-comment"),r.login===n&&this.element.classList.add("current-user");const f=me[c],E=y.reduce((C,T)=>C+d[T],0);let A="",B="";s||(n?(A=te(e.reactions.url,"right"),B=te(e.reactions.url,"left")):(A=ne("right"),B=ne("left"))),this.element.innerHTML=`
      ...
      <div class="comment">
        <header class="comment-header">
          <span class="comment-meta">
            ...
            \u8BC4\u8BBA<a class="text-link" href="${i}" target="_blank">${fe(Date.now(),new Date(o))}</a>
          </span>
          <div class="comment-actions">
            ${f?`<span class="author-association-badge">${f}</span>`:""}
            ${A}
          </div>
        </header>
    ...
    `);const i=r.nextElementSibling,o=i.lastElementChild,l=o.lastElementChild;return o.onclick=s,{setBusy(){l.textContent="\u52A0\u8F7D\u4E2D\u2026",o.disabled=!0},remove(){o.onclick=null,i.remove()}}}renderCount(){this.countAnchor.textContent=`${this.count>=1?`${this.count} \u6761\u8BC4\u8BBA`:"\u8FD8\u6CA1\u6709\u8BC4\u8BBA"}`}}const Ne=v(location);class Pe{constructor(e,n){u(this,"element");u(this,"avatarAnchor");u(this,"avatar");u(this,"form");u(this,"textExpander");u(this,"textarea");u(this,"preview");u(this,"submitButton");u(this,"signInAnchor");u(this,"submitting",!1);u(this,"renderTimeout",setTimeout(()=>{}));u(this,"handleInput",()=>{const e=this.textarea.value,n=/^\s*$/.test(e);this.submitButton.disabled=n,this.textarea.scrollHeight<450&&this.textarea.offsetHeight<this.textarea.scrollHeight&&(this.textarea.style.height=`${this.textarea.scrollHeight}px`,h()),clearTimeout(this.renderTimeout),n?this.preview.textContent=M:(this.preview.textContent="\u52A0\u8F7D\u9884\u89C8\u4E2D\u2026",this.renderTimeout=setTimeout(()=>Te(e).then(s=>this.preview.innerHTML=s).then(()=>Y(this.preview)).then(h),500))});u(this,"textExpand",()=>{this.textExpander.addEventListener("text-expander-change",e=>{const n=e,{key:s,provide:r,text:i}=n.detail;if(s==="@"){const o=document.createElement("ul");o.id="option-userList",o.classList.add("suggester","position-absolute","list-style-none");const l=JSON.parse(sessionStorage.getItem("commentUserList"))||[];if((l==null?void 0:l.length)>0){for(const c of l)if(c.toLowerCase().includes(i.toLowerCase())){const d=document.createElement("li");d.setAttribute("role","option"),d.textContent=c,d.setAttribute("data-value",c.split(" ")[0]),d.id=`option-${c.split(" ")[0]}`,o.append(d)}r(Promise.resolve({matched:!0,fragment:o}))}}}),this.textExpander.addEventListener("text-expander-value",e=>{const n=e,{key:s,item:r}=n.detail;s==="@"&&(n.detail.value=r.getAttribute("data-value")||r.textContent)})});u(this,"handleSubmit",async e=>{e.preventDefault(),!this.submitting&&(this.submitting=!0,this.textarea.disabled=!0,this.submitButton.disabled=!0,await this.submit(this.textarea.value).catch(()=>0),this.submitting=!1,this.textarea.disabled=!this.user,this.textarea.value="",this.submitButton.disabled=!1,this.handleClick(H(P({},e),{target:this.form.querySelector(".tabnav-tab.tab-write")})),this.preview.textContent=M)});u(this,"handleClick",({target:e})=>{if(!(e instanceof HTMLButtonElement)||!e.classList.contains("tabnav-tab")||e.getAttribute("aria-selected")==="true")return;this.form.querySelector('.tabnav-tab[aria-selected="true"]').setAttribute("aria-selected","false"),e.setAttribute("aria-selected","true");const n=e.classList.contains("tab-preview");this.textarea.style.display=n?"none":"",this.preview.style.display=n?"":"none",h()});u(this,"handleKeyDown",({key:e,ctrlKey:n})=>{e==="Enter"&&n&&!this.submitButton.disabled&&this.form.dispatchEvent(new CustomEvent("submit"))});this.user=e,this.submit=n,this.element=document.createElement("article"),this.element.classList.add("timeline-comment"),this.element.innerHTML=`
      ...
      </ol>`,"#q\u65E0\u6CD5\u4ECE-github-\u83B7\u53D6\u6570\u636E",!0),new Error(`api.github.com \u8BF7\u6C42\u5931\u8D25\u3002${i}`)}const n=new je(e,t);if(document.body.appendChild(n.element),t&&t.comments>0&&Ue(t,n),h(),t&&t.locked)return;Me(!!e);const s=async i=>{await Se(),t||(t=await ye(m.issueTerm,m.url,m.title,m.description||"",m.label),n.setIssue(t));const o=await Le(t.number,i);n.insertComment(o,!0),r.clear()},r=new Pe(e,s);m.inputPosition==="top"?n.element.insertAdjacentElement("afterbegin",r.element):n.element.appendChild(r.element)}Oe();addEventListener("not-installed",function t(){removeEventListener("not-installed",t),document.querySelector(".timeline").insertAdjacentHTML("afterbegin",`
  <div class="flash flash-error">
    \u9519\u8BEF: Beaudar \u6CA1\u6709\u5B89\u88C5\u5728 <code>${m.owner}/${m.repo}</code>\u3002
    \u5982\u679C\u4F60\u62E5\u6709\u8FD9\u4ED3\u5E93\uFF0C
    <a href="https://github.com/apps/beaudar" target="_blank"><strong>\u5B89\u88C5 app</strong></a>\u3002
  </div>`),h()});const R=(t,e)=>t%e<3&&t%e!=0;async function Ue(t,e){const n=d=>{for(const f of d)e.insertComment(f,!1)},s=Math.ceil(t.comments/$);let r=e.isDesc?s-1:2,i=[];e.isDesc?(s>1&&(i.push(b(t.number,s)),s>2&&R(t.comments,$)&&(r=s-2,i.push(b(t.number,s-1)))),i.push(b(t.number,1))):(i=[b(t.number,1)],s>1&&i.push(b(t.number,s)),s>2&&R(t.comments,$)&&(r=2,i.push(b(t.number,s-1))));const o=await Promise.all(i);for(const d of o)n(d);let l=s-i.length;const c=d=>{if(l===0)return;const f=async()=>{A.setBusy();const B=await b(t.number,r);A.remove(),n(B),l--,r=e.isDesc?--r:++r,c(B)},E=e.isDesc?d.shift():d.pop(),A=e.insertPageLoader(E,l*$,f)};e.isDesc&&R(t.comments,$)?c(o[1]):c(o[0])}
